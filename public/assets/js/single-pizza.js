...
// added in 18.3 to get the pizzas
function getPizza() {
  // get id of pizze
  ...
  .catch(err => {
    console.log(err);
    alert('Cannot find a piza with this id! Taking you back.');
    window.history.back();
  });
}
...
function handleNewCommentSubmit(event) {
  ...
  // add the ability to add a comment (POST data)
...
function handleNewReplySubmit(event) {
  ...
  // add the ability to add a reply (POST data)
...
// call the new getPizza() function
getPizza();